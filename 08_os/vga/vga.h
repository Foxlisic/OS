...
#define VGA_NUM_REGS         EQU (1 + VGA_NUM_SEQ_REGS + VGA_NUM_CRTC_REGS + VGA_NUM_GC_REGS + VGA_NUM_AC_REGS)

u8* VGAMEM = (u8*) 0x000A0000;   


/*
 * Данные для различных разрешений
 */

u8 vgamode_640x480[61] = {
/* misc: */
        0xE3,
...
/* ac */
        ...
        0x01, 0x01, 0x0F, 0x03, 0x00
};

/*
 * Шрифты (таблица символов)
 */
