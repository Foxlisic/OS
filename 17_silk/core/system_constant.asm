...
; Область памяти, где находится 4Мб блок доступности страниц
MM_FREE_PAGES           equ 0x400000
...
; 2Мб диск в памяти для хранения распакованного sys.bin
ADDR_RAM_DISK           equ 0x200000  
