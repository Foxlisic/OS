...
.search:
        ...
        ; Определение маски DOSX.COM
        cmp     [ss:si + 0], dword NAME_LOW
        jne     @f
        cmp     [ss:si + 4], dword NAME_HIGH
        jne     @f
        cmp     [ss:si + 7], dword NAME_EXT
        jne     @f
        jmp     .found
...
goto_program:
        ...
        ; Очистить перед запуском, [DL] = Drive Letter
...
error_kernelnot         db "(Fatal) No DOSX.COM file", 0
